...
ESPTab:CreateSection("Gun And Ammo Esp")
ESPTab:CreateToggle({
...
BringTab:CreateSection("Not recommended it brings everything and fills one spot of the camp")
...
BringTab:CreateSection("Heal And Close Child")
BringTab:CreateButton({
    Name = "Bring Bandage",
    Callback = function()
...
BringTab:CreateSection("Gun And Ammo")
BringTab:CreateButton({
    Name = "Bring Revolver",
    Callback = function()
        for _, item in ipairs(workspace.Items:GetChildren()) do
